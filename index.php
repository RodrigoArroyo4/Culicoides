    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="pages/about.php">More About</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="pages/publications.php">Publications</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="pages/institutions.php">Institutions using [Lorem Ipsum]</a>
          </li>
          <li class="nav-item">
  ...
  <div class="container-full">
    <div class="row">
      <div class="col-lg-12">
        ...
        <?php require 'content/content-homepage.php' ?> 
      </div>
    </div>
  </div>
