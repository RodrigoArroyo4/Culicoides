...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="about.php">More About</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="publications.php">Publications</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#">Institutions using [Lorem Ipsum]</a>
          </li>
          <li class="nav-item">
  ...
  <div class="container-full">
    <div class="row">
      <div class="col-lg-12">
        <h3 class="main-title-text">Institutions using Lorem Ipsum</h3>
      </div>
    </div>
  </div>
